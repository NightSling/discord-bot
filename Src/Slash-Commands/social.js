  ...
  async execute(interaction) {
    try {
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          'Stay connected with us through our social media channels. Use the dropdown menu below to select a platform.',
        )
      ...
      const filter = (i) =>
        i.customId === 'select-social' && i.user.id === interaction.user.id;
      ...
      collector.on('end', async () => {
        ...
        try {
          await message.edit({
            content:
              'Time expired. Please use the command again to view social media links.',
